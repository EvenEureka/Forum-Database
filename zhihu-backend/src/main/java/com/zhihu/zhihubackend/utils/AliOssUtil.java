...
public class AliOssUtil {
    ...
    private static final String ENDPOINT = ""; // 使用服务器，这里自己设置使用什么云
    // 从环境变量中获取访问凭证。运行本代码示例之前，请确保已设置环境变量OSS_ACCESS_KEY_ID和OSS_ACCESS_KEY_SECRET。
//        EnvironmentVariableCredentialsProvider credentialsProvider = CredentialsProviderFactory.newEnvironmentVariableCredentialsProvider();
    // 记得恢复下面两行
    // private static final String ACCESS_KEY = ""; // Your Key
    // private static final String ACCESS_SECRET = ""; // Your Secret
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKETNAME = "lyw-zhihu";
